...
## Active Technologies
- Python 3.11+ + FastAPI (web framework), SQLModel (ORM), python-jose (JWT), passlib with bcrypt (password hashing), pydantic (validation) (002-task-crud)
- Neon Serverless PostgreSQL (accessed via DATABASE_URL environment variable) (002-task-crud)
...
## Recent Changes
- 002-task-crud: Added Python 3.11+ + FastAPI (web framework), SQLModel (ORM), python-jose (JWT), passlib with bcrypt (password hashing), pydantic (validation)
